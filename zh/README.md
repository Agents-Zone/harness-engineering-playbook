...
[AgentsZone](https://agentszone.ai)（Agent 特区）是一个聚焦 AI 工程实践的中文开发者社区，成员在各自的真实项目中大量使用 AI Agent 做交付。社区每周六晚上有一场线上分享，由实践者拆解真实案例；日常讨论围绕 Agent 落地中的质量管理、流程设计和团队重组展开。社区的态度是"鼓励探索，鼓励挑战，不鼓励客气"。这本书从社区上百次实践交流中提炼而来。

> **⚠️ 早期草稿** 本书正处于架构验证阶段。引言和目录结构已基本成型，欢迎对整体框架提出反馈。各章节仍需补充细节、实例和可读性打磨，欢迎实践贡献者逐章参与完善。

## Agent Coding：1.5x 还是 100x

AI 两年前只能补全函数，现在能生成整个项目。大多数开发者觉得自己变成了 1.5 倍工程师，但交付数据不好看：PR 变多了，review 变慢了，bug 率上升了。另一批人用同样的工具做到了几十倍，代码上了生产。同样的工具，差距在哪里？本书把 AgentsZone 社区和上百位开发者的实践整理成册，回答这个问题。
...
> "那真是个孤独的探索者，自己有想法，自己去实践：错了，再来；对了，继续。因为总体比较前沿，外面也不见得能找到什么有用的资料。自己也能探索出一些结论来，但总体效率非常低。进群之后发现很多自己的探索结论早就是 common sense 了。成功、失败经验远不是个人实践可以比的。"
>
> —— 陈浩
